...
function App() {
  ...
  "
      ...
      <main>
        <motion.section
          id="acercaDeMi"
          className="flex flex-col bg-white text-warhol-ink w-full px-20 place-items-center py-24 mb-12 rounded-lg shadow-lg"
      ...
      <div className="relative w-full flex justify-center items-center">
        ...
        <motion.section
          id="comunicacion"
          className="flex flex-col bg-white text-warhol-ink w-full px-20 place-items-center py-24 mb-12 rounded-lg shadow-lg overflow-hidden"
          initial={{ opacity: 0, scale: 0.5 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{
            duration: 0.8,
        ...
        <motion.section id='desarrollo' className='flex flex-col bg-white text-warhol-ink w-full px-20 place-items-center py-24 mb-12 rounded-lg shadow-lg'
          initial={{ opacity: 0, scale: 0.5 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{
            duration: 0.8,
        ...
        <motion.section id='creatividad' className='flex flex-col bg-white text-warhol-ink w-full px-20 place-items-center py-24  mb-12 rounded-lg shadow-lg'
          initial={{ opacity: 0, scale: 0.5 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{
            duration: 0.8,
        ...
        <motion.section id='humor' className='flex flex-col bg-white text-warhol-ink w-full px-20 place-items-center py-24  mb-12 rounded-lg shadow-lg'
          initial={{ opacity: 0, scale: 0.5 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{
            duration: 0.8,
